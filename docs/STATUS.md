...
| **Tests — frontend** | `pnpm test` on `art-291-clear-on-removal` (merged as `1596fe4`), 2026-09-10: `Test Files 107 passed (107)`, `Tests 1628 passed (1628)` — the four-tab rewrite's 1609, ART-278's two, ART-283's three, ART-285's five, ART-294's two, ART-292's three, ART-291's four. On the 0.9.1 release head, 2026-09-09: 91 / 1388 |
