...
| **Build** | PASS |
| **Tests** | 1519 Rust passed, 0 failed, 9 ignored (real-media hooks, env-gated — see below); 567 frontend passed, 0 failed |
...
| **i18n** | `en.json` and `tr.json`, 1495 leaf keys each, parity enforced by `pnpm test` |
