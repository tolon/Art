...
| **Tests — frontend** | `pnpm test` on `main` at `0737c2d`, 2026-09-10: `Test Files 107 passed (107)`, `Tests 1614 passed (1614)` — the four-tab rewrite's 1609, ART-278's two, ART-283's three. On the 0.9.1 release head, 2026-09-09: 91 / 1388 |
