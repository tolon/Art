...
| **i18n** | `en.json` and `tr.json`, 1829 leaf keys each (1847 until ART-179 removed seventeen keys nothing rendered), parity enforced by `pnpm test` |
