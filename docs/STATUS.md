...
2. **A Turkish 3.9 tree booted and a ş looked at.** The fonts are placed,
   named and paired with their descriptors, and that they *render* is the one
   thing this round did not ask the artefact — the only claim it deliberately
   left unmade.
