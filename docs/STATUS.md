...
[ISSUES.md](ISSUES.md#fixed) under ART-317 and in the [session log](session-log.md). **Next:** item 3 of the third
debt round — ART-319's disclosed gaps (`rename_in` in one commit, copy-on-write `overwrite_file_in`, rollback/lock
tests for the nine untested mutators); none of the items below are it.
