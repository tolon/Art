...
| **Build** | PASS |
| **Tests** | 1609 Rust passed, 0 failed, 10 ignored (real-media hooks, env-gated — see below); 569 frontend passed, 0 failed |
...
| **i18n** | `en.json` and `tr.json`, 1528 leaf keys each, parity enforced by `pnpm test` |
