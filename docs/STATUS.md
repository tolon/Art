...
| **Build** | PASS |
| **Tests** | 1618 Rust passed, 0 failed, 11 ignored (real-media hooks, env-gated — see below); 570 frontend passed, 0 failed |
...
| **i18n** | `en.json` and `tr.json`, 1531 leaf keys each, parity enforced by `pnpm test` |
