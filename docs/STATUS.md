...
| **Build** | PASS |
| **Tests** | 1585 Rust passed, 0 failed, 9 ignored (real-media hooks, env-gated — see below); 569 frontend passed, 0 failed |
...
| **i18n** | `en.json` and `tr.json`, 1514 leaf keys each, parity enforced by `pnpm test` |
