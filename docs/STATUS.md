...
0000. **The Files screen's columns are resizable, hideable and remembered, merged as `cdcc54b`, not pushed.** Design § 5 of the 2026-09-08 simplification spec, asked for again by the owner the same night; FEATURES has the row and its one deviation. **Owed by a person (§ 5.10):** hide Ext, widen Date, restart ART and see both kept; turn the text up to 28 px; narrow a pane until Date and Attr go and come back; Reset. **ART-303 is the owner's call:** two different BoingBag 3.9-1 archives in `E:/amiga/Amigatolon/paketler` leave that row unresolved, and Build still runs BoingBag 3.9-2 alone, which the core refuses — withholding Build reverses a test's stated design.
