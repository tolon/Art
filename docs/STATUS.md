...
| | |
|---|---|
| **Last updated** | 2026-08-19 (OS install screen: first automated coverage, `ART-118` narrowed) |
...
| **Build** | PASS |
| **Tests** | 1716 Rust passed, 0 failed, 11 ignored (real-media hooks, env-gated — see below); 599 frontend passed, 0 failed |
