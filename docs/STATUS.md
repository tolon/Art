...
| **Version** | 0.8.5 — the first version published for other people to use. Deliberately not 1.0: of 233 marked rows in [FEATURES.md](FEATURES.md), 161 are green — **32 amber, 34 not started, 6 stubs** (counted 2026-09-04; the previous figure, "30 amber", predates several rounds), and as the row above says, what is left in SD-1 is not code: a card flashed and an A500 booted. That is the bar for 1.0, not a bigger number |
