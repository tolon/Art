...
**The one-button card's round 2 is done on its branch, `art-card-round-2` — not merged, not pushed; ready to merge
on the owner's word.** The final whole-branch review's fix wave (`952f217`) passed its scoped re-review
