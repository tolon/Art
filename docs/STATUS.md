...
Four mutations red, none survived. Counts: `cargo test --lib` `test result: ok. 3420 passed; 0 failed; 60 ignored; 0 measured; 0 filtered out` twice (390 s, 412 s, `TMP`/`TEMP` on `E:`); `pnpm test` 111 / 1685;
fmt, clippy, lint and three sweeps clean. **Next:** push and watch CI once, then the owner's merge word.
...
0000000000000000. **ART-062's mechanical part is done on `art-debt-2-0914` (not merged) — the one Turkish string
...
000000000000000. **ART-250 is fixed on `art-debt-2-0914` (not merged): ToolTypes are Latin-1, byte-exact.**
