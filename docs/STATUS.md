...
| **Tests — frontend** | `pnpm test` on the merged `main` (`f9602c3`), 2026-09-10: `Test Files 107 passed (107)`, `Tests 1611 passed (1611)` — the four-tab rewrite's 1609 plus ART-278's two. On the 0.9.1 release head, 2026-09-09: 91 / 1388 |
