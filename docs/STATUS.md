...
| | |
|---|---|
| **Last updated** | 2026-08-18 (WHDLoad retry: `1000 Miglia` reached the game) |
...
| **Build** | PASS |
| **Tests** | 1716 Rust passed, 0 failed, 11 ignored (real-media hooks, env-gated — see below); 593 frontend passed, 0 failed |
