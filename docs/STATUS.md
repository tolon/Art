...
| **`main` / `origin`** | Identical at `9fffc52` (ART-281 merged `--no-ff` from `art-281-scratch` and pushed 2026-09-10 on the owner's word, taking `ad61a7a`'s release docs with it; CI run 34464414055 was in progress when this row was written — read the run, not this row). Before that `7ee91fa` was 0.9.1's merge, tag `v0.9.1` |
