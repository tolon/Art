...
| **i18n** | `en.json` and `tr.json`, 1822 leaf keys each, parity enforced by `pnpm test` |
...
2. **The package-bundles work list's items 4-9** — identify install media by
   ...
   [ART-205](ISSUES.md) (the plan predicts 18% more bytes than land) and
   [ART-196](ISSUES.md) (scratch on `C:`) are still open and still first.
