...
| **Build** | PASS |
| **Tests** | 1875 Rust passed, 0 failed, 20 ignored (real-media hooks, env-gated — see below); 619 frontend passed, 0 failed |
