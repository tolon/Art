...
| **i18n** | `en.json` and `tr.json`, 1779 leaf keys each, parity enforced by `pnpm test` |
...
**The engine builds a distribution. The screen still has not.** That sentence
