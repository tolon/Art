...
00000000000000. **ART-319 is fixed on `art-319-writer-rollback`, not merged: the PFS3 writer returns to its
...
sweeps clean. **Merging is the owner's word.** The ART-317 bullet below said "Next: ART-319 if the owner
