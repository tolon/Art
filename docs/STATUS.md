...
| | |
|---|---|
| **Last updated** | 2026-08-19 (AmigaOS 3.9: a second `MediaSource` reads a real install disc image, and the real 469 MiB disc builds the recipe's **one** component — `workbench-base`, 588 files, ~6 MB — end to end. Not a complete 3.9 system and **not yet booted**; `FEATURES.md`'s row is the precise statement) |
