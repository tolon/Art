...
| **Build** | PASS |
| **Tests** | 1669 Rust passed, 0 failed, 11 ignored (real-media hooks, env-gated — see below); 586 frontend passed, 0 failed |
