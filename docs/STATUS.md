...
| **Tests — frontend** | `pnpm test` on `art-091-fixes`, 2026-09-09: `Test Files 91 passed (91)`, `Tests 1386 passed (1386)` — 1 410 the day before, on the same branch. On the merged `main` (`e0fb4aa`), 2026-09-08: 91 / 1410 |
