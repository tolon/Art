...
| **Build** | PASS |
| **Tests** | 1399 Rust passed, 0 failed, 3 ignored (real-media hooks, env-gated — see below); 526 frontend passed, 0 failed |
...
| **i18n** | `en.json` and `tr.json`, 1457 leaf keys each, parity enforced by `pnpm test` |
