...
wave and filed open:** [ART-323](ISSUES.md#open) (libpfs3 deletes a hard link by freeing the file it names —
measured; unreachable from ART) and [ART-324](ISSUES.md#open) (sizes of 4 GiB or more lose their high bits in the
writer; unreachable).
...
**Next:** a scoped re-review of the fix wave, then the merge, the push and the 0.9.4 build — all the owner's word.
