...
| **`main` / `origin`** | `main` is at `e0fb4aa` — the three intake rounds merged `--no-ff` on 2026-09-08 (the owner's decision after the final build), on top of the Windows 11 look (`13e6707`); `origin/main` is still `76eac3d`, so **everything since the evening of 2026-09-07 is unpushed** until the owner says push. CI run 34151589760 passed on `76eac3d` |
