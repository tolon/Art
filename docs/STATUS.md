...
| | |
|---|---|
| **Last updated** | 2026-08-19 (AmigaOS 3.9: a second `MediaSource` reads a real install CD, and the real 469 MiB disc builds a complete distribution tree — **not yet booted**) |
