...
| | |
|---|---|
| **Last updated** | 2026-09-14 — plan 5 fixed on `art-debt-0914`, unmerged: **ART-317, every Amiga date ART
...
0000000000000. **ART-317 is fixed on `art-debt-0914`, not merged: every Amiga date ART makes from an instant is
...
all five plans closed, each with its final review's fixes re-reviewed.** **Next:** merging `art-debt-0914`
into `main` and pushing, both on the owner's word; ART-319 if the owner schedules it. Reports and the spec: `.superpowers/sdd/2026-09-14-debt-5-art-317-local-time/`.
