...
| **Build** | PASS |
| **Tests** | 1419 Rust passed, 0 failed, 4 ignored (real-media hooks, env-gated — see below); 533 frontend passed, 0 failed |
